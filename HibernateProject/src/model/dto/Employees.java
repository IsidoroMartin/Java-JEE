 ...
 */
public class Employees extends GenericDTO implements java.io.Serializable {
	...
	public Employees(int employeeId, Employees employees,
			...
			BigDecimal salary, BigDecimal commissionPct, Set departmentses,
	...
	public String toString() {
		return "Employees [employeeId=" + employeeId + ", firstName="
				+ firstName + ", lastName=" + lastName + "Department: "
				+ departments.getDepartmentId() + "]";
	}

	@Override
	public boolean equals(Object obj) {
		return ((obj != null) && (obj instanceof Employees)
				&& (((Employees) obj).employeeId == this.employeeId) 
				&& (((Employees) obj).firstName.equals(this.firstName))
				&& (((Employees) obj).lastName.equals(this.lastName))
				&& (((Employees) obj).email.equals(this.email))				
				);
	}
